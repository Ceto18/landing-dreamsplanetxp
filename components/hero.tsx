                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-[600px]">
                    ...
                    <div className="space-y-8 animate-fade-in-up">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            ...
                            <a
                                href="#momentos"
                                className="px-6 py-2.5 rounded-lg font-medium text-sm bg-transparent text-foreground border border-accent/40 hover:bg-accent/10 hover:border-accent hover:text-accent transition-all duration-300 flex items-center justify-center gap-2 no-underline"
                            >
                    ...
                    <div className="hidden lg:flex justify-end animate-slide-in">
                        <div className="w-full max-w-sm relative overflow-hidden rounded-2xl border border-border/40 bg-background/40 backdrop-blur-md p-8 space-y-6 shadow-2xl glow-gold">
                            {/* Decorative corner */}
