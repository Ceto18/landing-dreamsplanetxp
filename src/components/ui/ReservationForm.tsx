        ...
        <div className="space-y-8 rounded-3xl border border-border/60 bg-card/50 p-8 shadow-2xl glass-effect">
            ...
            >
                ...
                <PhoneInput
                    ...
                    className="w-full rounded-lg border border-border bg-transparent px-4 py-3 transition-all focus-within:border-accent focus-within:ring-1 focus-within:ring-accent/30 [&_.PhoneInputCountry]:mr-3 [&_.PhoneInputCountrySelect]:cursor-pointer [&_.PhoneInputCountrySelect]:bg-background [&_.PhoneInputCountrySelect]:text-foreground [&_.PhoneInputInput]:border-none [&_.PhoneInputInput]:bg-transparent [&_.PhoneInputInput]:text-foreground [&_.PhoneInputInput]:outline-none [&_.PhoneInputInput::placeholder]:text-muted-foreground"
                />
